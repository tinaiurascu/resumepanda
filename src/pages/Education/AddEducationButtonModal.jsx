...
const AddEducationButtonModal = (props) => {
  const { toast } = props;
  ...
  const handleSubmit = async (event) => {
    ...
    await FirestoreService.createEducation(user, {
      school,
      fieldOfStudy,
      degree,
      endDate,
  ...
  return (
    <>
      <Button variant="primary" onClick={handleShow}>
        Adaugă educație nouă
      </Button>

      <Modal show={show} onHide={handleClose}>
        <Modal.Header closeButton>
          <Modal.Title>Adaugă o nouă educație</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Form
            noValidate
...
export default AddEducationButtonModal;
