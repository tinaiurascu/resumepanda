...
const EditResumeButtonModal = (props) => {
  const {
    id,
    allExperiences,
  ...
  const [resumeTitle, setResumeTitle] = useState(defaultResumeTitle);
  ...
  const handleSubmit = async (event) => {
    ...
    await FirestoreService.updateResumeDocument(id, {
      resumeTitle,
      imageURL,
      resumeExperience,
    }).then(() => toast("Educația a fost editată cu success!"));
    handleClose();
  };
    ...
    <>
      ...
      <Modal show={show} onHide={handleClose}>
        <Modal.Header closeButton>
          <Modal.Title>Editează Resume</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Form
            noValidate
...
export default EditResumeButtonModal;
